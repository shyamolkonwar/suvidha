        ...
        <footer className="footer" id="help">
            <div className="container">
                <div className="footer-inner">
                    ...
                    <div className="footer-brand">
                        <div className="footer-logo">
                            ...
                            <span className="footer-logo-text">SUVIDHA</span>
                        </div>
                        <p className="footer-tagline">
                            Smart city governance for every citizen. Making public services
                            accessible, transparent, and fast.
                        </p>
                    </div>
                    ...
                    <div className="footer-col">
                        ...
                        <a href="#services">Water Supply</a>
                        <a href="#services">Municipal</a>
                ...
                <div className="footer-bottom">
                    <span>© 2026 SUVIDHA. All rights reserved.</span>
